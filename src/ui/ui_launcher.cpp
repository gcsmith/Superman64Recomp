...
void select_rom() {
    ...
    superman64::open_file_dialog([](bool success, const std::filesystem::path& path) {
        if (success) {
...
public:
    ...
    void load_document() override {
		launcher_context = recompui::create_context(superman64::get_asset_path("launcher.rml"));
    }
