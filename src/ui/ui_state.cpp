...
public:
    ...
    UIState(SDL_Window* window, plume::RenderInterface* interface, plume::RenderDevice* device) {
        ...
        Rml::Debugger::Initialise(context);
        {
            ...
            for (const FontFace& face : font_faces) {
                auto font = superman64::get_asset_path(face.filename);
    ...
    void create_menus() {
        recompui::init_styling(superman64::get_asset_path("recomp.rcss"));
        ...
        if (!recomp::all_input_disabled()) {
            ...
            case SDL_EventType::SDL_KEYDOWN:
                ...
                if (cur_event.key.keysym.scancode == SDL_Scancode::SDL_SCANCODE_F8) {
                    if (superman64::get_debug_mode_enabled()) {
...
void recompui::message_box(const char* msg) {
    SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, superman64::program_name.data(), msg, nullptr);
    printf("[ERROR] %s\n", msg);
}
