...
static void add_general_options(recomp::config::Config &config) {
    ...
    static EnumOptionVector note_saving_mode_options = {
        {superman64::NoteSavingMode::Off, "Off", "Off"},
        {superman64::NoteSavingMode::On, "On", "On"},
    };
    config.add_enum_option(
        superman64::configkeys::general::note_saving_mode,
        "Note Saving",
        ...
        superman64::NoteSavingMode::On
    );
    static EnumOptionVector analog_cam_mode_options = {
        {superman64::AnalogCamMode::Off, "Off", "Off"},
        {superman64::AnalogCamMode::On, "On", "On"},
    };
    config.add_enum_option(
        superman64::configkeys::general::analog_cam_mode,
        "Analog Camera",
        "Enables the analog camera.",
        analog_cam_mode_options,
        superman64::AnalogCamMode::Off
    );
    config.add_number_option(
        superman64::configkeys::general::analog_camera_sensitivity,
    ...
    static EnumOptionVector camera_invert_mode_options = {
        {superman64::CameraInvertMode::InvertNone, "InvertNone", "None"},
        {superman64::CameraInvertMode::InvertX, "InvertX", "Invert X"},
        {superman64::CameraInvertMode::InvertY, "InvertY", "Invert Y"},
        {superman64::CameraInvertMode::InvertBoth, "InvertBoth", "Invert Both"}
    };
    config.add_enum_option(
        superman64::configkeys::general::third_person_camera_invert_mode,
        "Invert Camera",
        ...
        superman64::CameraInvertMode::InvertX
    );
    ...
    config.add_enum_option(
        superman64::configkeys::general::first_person_invert_mode,
        ...
        superman64::CameraInvertMode::InvertY
    );
    ...
    config.add_enum_option(
        superman64::configkeys::general::flying_and_swimming_invert_mode,
...
superman64::NoteSavingMode superman64::get_note_saving_mode() {
    return get_general_config_enum_value<superman64::NoteSavingMode>(superman64::configkeys::general::note_saving_mode);
}

superman64::CameraInvertMode superman64::get_camera_invert_mode() {
    return get_general_config_enum_value<superman64::CameraInvertMode>(superman64::configkeys::general::camera_invert_mode);
}

superman64::CameraInvertMode superman64::get_analog_camera_invert_mode() {
    return get_general_config_enum_value<superman64::CameraInvertMode>(superman64::configkeys::general::third_person_camera_invert_mode);
}

superman64::AnalogCamMode superman64::get_analog_cam_mode() {
    return get_general_config_enum_value<superman64::AnalogCamMode>(superman64::configkeys::general::analog_cam_mode);
}

uint32_t superman64::get_analog_cam_sensitivity() {
    return get_general_config_number_value(superman64::configkeys::general::analog_camera_sensitivity);
}
...
static void add_sound_options(recomp::config::Config &config) {
    config.add_percent_number_option(
        superman64::configkeys::sound::bgm_volume,
...
int superman64::get_bgm_volume() {
    return get_sound_config_number_value<int>(superman64::configkeys::sound::bgm_volume);
}

static void add_graphics_options(recomp::config::Config &config) {
    using EnumOptionVector = const std::vector<recomp::config::ConfigOptionEnumOption>;
    static EnumOptionVector cutscene_aspect_ratio_mode_options = {
        {superman64::CutsceneAspectRatioMode::Original, "Original", "Original"},
        {superman64::CutsceneAspectRatioMode::Clamp16x9, "Clamp16x9", "16:9"},
        {superman64::CutsceneAspectRatioMode::Full, "Expand", "Expand"},
    };
    config.add_enum_option(
        superman64::configkeys::graphics::cutscene_aspect_ratio_mode,
        ...
        superman64::CutsceneAspectRatioMode::Clamp16x9
    );    
}
...
static void set_control_descriptions() {
    ...
    recompinput::set_game_input_description(recompinput::GameInput::R, "Used to center the camera behind superman64 on the ground, and to perform tighter turns while flying or swimming.");
...
superman64::CutsceneAspectRatioMode superman64::get_cutscene_aspect_ratio_mode() {
    return get_graphics_config_enum_value<superman64::CutsceneAspectRatioMode>(superman64::configkeys::graphics::cutscene_aspect_ratio_mode);
}

void superman64::init_config() {
