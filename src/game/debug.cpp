...
void superman64::do_warp(int area, int scene, int entrance) {
    const superman64::SceneWarps game_scene = superman64::game_warps[area].scenes[scene];
...
void superman64::set_time(uint8_t day, uint8_t hour, uint8_t minute) {
